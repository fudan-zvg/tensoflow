...
def eval_relight(model_name, relight_dir, gt_dir):
    relight_env_name = gt_dir.split('/')[-1]
    save_dir = f'data/relight/orb/{model_name}/afterScale/{relight_env_name}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--relight_dir', type=str, default='data/relight/orb/teapot_scene006_relighting_teapot_scene001',
                        help='relighted images from blender')
    parser.add_argument('--gt_dir', type=str, default='nerf_data/blender_LDR/teapot_scene001',
    ...
    relight_dir = f'data/relight/orb/{cfg["name"]}/noScale/{flags.relight_dir}'
    eval_relight(cfg['name'], relight_dir, flags.gt_dir)